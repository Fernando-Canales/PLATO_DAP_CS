...
- [x] [[Referee_comments|Major 1]]: State in the latex document that is not our aim to estimate a realistic EB rate for PLATO. Such thing has be done already (see Bray et al. 2023). I can also mention the Kepler and TESS papers from Prsa. 
