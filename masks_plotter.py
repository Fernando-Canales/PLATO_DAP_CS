...
# Define and plot the nominal mask
...
fig, ax = plt.subplots()
ax.imshow(nominal_mask, origin='lower', extent=(0, 6, 0, 6))
ax.plot(center_x, center_y, 'o', color='green', markersize=10, markeredgecolor='black')  # Center point
for (x, y) in contaminants:
    ax.plot(x, y, '^', color='cyan', markersize=10, markeredgecolor='black')  # Contaminants as triangles
ax.grid(which='both', color='white', linestyle='--', linewidth=2)
plt.title('Nominal Mask')
plt.show()

# Define and plot the secondary mask
...
fig, ax = plt.subplots()
ax.imshow(secondary_mask, origin='lower', extent=(0, 6, 0, 6))
ax.plot(center_x, center_y, 'o', color='green', markersize=10, markeredgecolor='black')  # Center point
for (x, y) in contaminants:
    ax.plot(x, y, '^', color='cyan', markersize=10, markeredgecolor='black')  # Contaminants as triangles
ax.grid(which='both', color='white', linestyle='--', linewidth=2)
plt.title('Secondary Mask')
plt.show()
...
fig, ax = plt.subplots()
ax.imshow(extended_mask, origin='lower', extent=(0, 6, 0, 6))
ax.plot(center_x, center_y, 'o', color='green', markersize=10, markeredgecolor='black')  # Center point
for (x, y) in contaminants:
    ax.plot(x, y, '^', color='cyan', markersize=10, markeredgecolor='black')  # Contaminants as triangles
ax.grid(which='both', color='white', linestyle='--', linewidth=2)
